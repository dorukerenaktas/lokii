...
class DatasetGenerator:
    def __init__(self, table_conf: DatasetTableDefinition, fake_conf: FakeDataConfig,
                 exec_conf: ExecutionConfig, storage: DatasetStorageService):
        """
    ...
    def __generate_simple(self):
        ...
        for batch_index in range(batch_count):
            ...
            to_index = from_index + batch_size \
                if from_index + batch_size < target_row_count else target_row_count
